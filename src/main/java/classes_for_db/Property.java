...
public class Property implements DbTableObject {
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getZestimate()
   */
  ...
  /**
   * @param zestimate
   * @see main.java.classes_for_db.Zestimate#setZestimate(int)
   */
  ...
  /**
   * @param zestimate
   * @see main.java.classes_for_db.Zestimate#setZestimate(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getLastUpdated()
   */
  ...
  /**
   * @param lastUpdated
   * @see main.java.classes_for_db.Zestimate#setLastUpdated(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getThirtyDayChange()
   */
   ...
   * @see main.java.classes_for_db.Zestimate#setThirtyDayChange(int)
   */
  ...
  /**
   * @param thirtyDayChange
   * @see main.java.classes_for_db.Zestimate#setThirtyDayChange(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getValuationHigh()
   */
  ...
  /**
   * @param valuationHigh
   * @see main.java.classes_for_db.Zestimate#setValuationHigh(int)
   */
  ...
  /**
   * @param valuationHigh
   * @see main.java.classes_for_db.Zestimate#setValuationHigh(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getvaluationLow()
   */
  ...
  /**
   * @param valuationLow
   * @see main.java.classes_for_db.Zestimate#setvaluationLow(int)
   */
  ...
  /**
   * @param valuationLow
   * @see main.java.classes_for_db.Zestimate#setvaluationLow(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Zestimate#getPercentileValue()
   */
   ...
   * @see main.java.classes_for_db.Zestimate#setPercentileValue(float)
   */
  ...
  /**
   * @param percentileValue
   * @see main.java.classes_for_db.Zestimate#setPercentileValue(java.lang.String)
   */
  ...
  /**
   * @param rentZestimate
   * @see main.java.classes_for_db.Zestimate#setRentZestimate(int)
   */
  ...
  /**
   * @param rentZestimate
   * @see main.java.classes_for_db.Zestimate#setRentZestimate(java.lang.String)
   */
   ...
   * @see main.java.classes_for_db.Zestimate#setRentThirtyDayChange(int)
   */
  ...
  /**
   * @param rentThirtyDayChange
   * @see main.java.classes_for_db.Zestimate#setRentThirtyDayChange(java.lang.String)
   */
  ...
  /**
   * @param minRent
   * @see main.java.classes_for_db.Zestimate#setMinRent(int)
   */
  ...
  /**
   * @param minRent
   * @see main.java.classes_for_db.Zestimate#setMinRent(java.lang.String)
   */
  ...
  /**
   * @param maxRent
   * @see main.java.classes_for_db.Zestimate#setMaxRent(int)
   */
  ...
  /**
   * @param maxRent
   * @see main.java.classes_for_db.Zestimate#setMaxRent(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Neighborhood#getRegionID()
   */
  ...
  /**
   * @param regionID
   * @see main.java.classes_for_db.Neighborhood#setRegionID(int)
   */
  ...
  /**
   * @param regionID
   * @see main.java.classes_for_db.Neighborhood#setRegionID(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Neighborhood#getName()
   */
  ...
  /**
   * @param name
   * @see main.java.classes_for_db.Neighborhood#setName(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Neighborhood#getzIndexChange()
   */
  ...
  /**
   * @param zIndexChange
   * @see main.java.classes_for_db.Neighborhood#setzIndexChange(float)
   */
  ...
  /**
   * @param zIndexChange
   * @see main.java.classes_for_db.Neighborhood#setzIndexChange(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.Neighborhood#getType()
   */
  ...
  /**
   * @param type
   * @see main.java.classes_for_db.Neighborhood#setType(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.TaxAssessment#getTaxYear()
   */
  ...
  /**
   * @param taxYear
   * @see main.java.classes_for_db.TaxAssessment#setTaxYear(int)
   */
  ...
  /**
   * @param taxYear
   * @see main.java.classes_for_db.TaxAssessment#setTaxYear(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.TaxAssessment#getTaxAssessment()
   */
  ...
  /**
   * @param taxAssessment
   * @see main.java.classes_for_db.TaxAssessment#setTaxAssessment(float)
   */
  ...
  /**
   * @param taxAssessment
   * @see main.java.classes_for_db.TaxAssessment#setTaxAssessment(String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getStatus()
   */
  ...
  /**
   * @param status
   * @see main.java.classes_for_db.PropertyDetails#setStatus(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getPosting_type()
   */
  ...
  /**
   * @param posting_type
   * @see main.java.classes_for_db.PropertyDetails#setPosting_type(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getLastUpdatedString()
   */
  ...
  /**
   * @param lastUpdated
   * @see main.java.classes_for_db.PropertyDetails#setLastUpdated(java.util.Date)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getyearUpdated()
   */
  ...
  /**
   * @param yearUpdated
   * @see main.java.classes_for_db.PropertyDetails#setyearUpdated(int)
   */
  ...
  /**
   * @param yearUpdated
   * @see main.java.classes_for_db.PropertyDetails#setyearUpdated(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getNumFloors()
   */
  ...
  /**
   * @param numFloors
   * @see main.java.classes_for_db.PropertyDetails#setNumFloors(int)
   */
  ...
  /**
   * @param numFloors
   * @see main.java.classes_for_db.PropertyDetails#setNumFloors(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getBasement()
   */
  ...
  /**
   * @param basement
   * @see main.java.classes_for_db.PropertyDetails#setBasement(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getRoofType()
   */
  ...
  /**
   * @param roofType
   * @see main.java.classes_for_db.PropertyDetails#setRoofType(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getParkingType()
   */
  ...
  /**
   * @param parkingType
   * @see main.java.classes_for_db.PropertyDetails#setParkingType(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getRooms()
   */
  ...
  /**
   * @param rooms
   * @see main.java.classes_for_db.PropertyDetails#setRooms(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getNumRooms()
   */
  ...
  /**
   * @param numRooms
   * @see main.java.classes_for_db.PropertyDetails#setNumRooms(int)
   */
  ...
  /**
   * @param numRooms
   * @see main.java.classes_for_db.PropertyDetails#setNumRooms(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getHomeDescription()
   */
   ...
   * @see main.java.classes_for_db.PropertyDetails#setHomeDescription(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getNeighborhoodName()
   */
   ...
   * @see main.java.classes_for_db.PropertyDetails#setNeighborhoodName(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getSchoolDistrict()
   */
   ...
   * @see main.java.classes_for_db.PropertyDetails#setSchoolDistrict(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getPageViewThisMonth()
   */
   ...
   * @see main.java.classes_for_db.PropertyDetails#setPageViewThisMonth(int)
   */
  ...
  /**
   * @param pageViewThisMonth
   * @see main.java.classes_for_db.PropertyDetails#setPageViewThisMonth(java.lang.String)
   */
  ...
  /**
   * @return
   * @see main.java.classes_for_db.PropertyDetails#getPageViewsTotal()
   */
   ...
   * @see main.java.classes_for_db.PropertyDetails#setPageViewsTotal(int)
   */
  ...
  /**
   * @param pageViewsTotal
   * @see main.java.classes_for_db.PropertyDetails#setPageViewsTotal(java.lang.String)
   */
