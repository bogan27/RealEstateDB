 ...
 * @author ronfarizon
 */
public class DemoGeo implements DbTableObject {
  ...
  public void setPop(int pop) {
    if (pop < 0) {
      throw new IllegalArgumentException(
          "Argument for population must be positive. Argument given: " + pop);
    } else {
      this.pop = pop;
    }
  }
  ...
  public void setMedianAge(double med) {
    if (med < 0) {
      throw new IllegalArgumentException(
          "Argument for median age must be positive. Argument given: " + med);
    } else {
      this.median_age = med;
    }
  }
  ...
  public void setPctFemale(double pct) {
    if (pct < 0 || pct > 100) {
      throw new IllegalArgumentException(
          "Argument for pct female must be between 0 and 100. Argument given: " + pct);
    } else {
      this.pct_female = pct;
    }
  }
  ...
  public int getPopOver(int age) {
    if (age == 18) {
      ...
      throw new IllegalArgumentException(
          "Data available only for population over 18, 25, and 65 years of age");
    }
  }
  ...
  public void setPopOver(int age, int pop) {
    if (pop < 0) {
      ...
      throw new IllegalArgumentException(
          "Population of age segment can't be greater than overall population");
    } else if (age == 18) {
      this.pop_18 = pop;
    } else if (age == 25) {
      this.pop_25 = pop;
  ...
  public double getPctFemaleOver(int age) {
    if (age == 18) {
      ...
      throw new IllegalArgumentException(
          "% Female data is available only for populations over 18 and 65 " + "years of age");
    }
  }
  ...
  public int getRacePop(String race) {
    if (race.toLowerCase().equals("white")) {
      ...
      if (race.toLowerCase().equals("native") || race.toLowerCase().equals("native american")) {
      return native_pop;
    } else if (race.toLowerCase().equals("pacific islander")
        || race.toLowerCase().equals("islander")) {
      return pac_islander_pop;
    } else if (race.toLowerCase().equals("other") || race.toLowerCase().equals("other race")) {
      return other_race_pop;
    } else {
      throw new IllegalArgumentException(
          "Expected races: white, black, asian, islander, native, or other. Given: " + race);
    }
  }
  ...
  public void setRacePop(String race, int pop) {
    if (pop < 0) {
      ...
      throw new IllegalArgumentException(
          "Population of race segment can't be greater than overall population");
  ...
  public double getPctEdu(String edu) {
    if (edu.toLowerCase().equals("less hs") || edu.toLowerCase().equals("less than hs")) {
      ...
      return pct_some_col;
    } else if (edu.toLowerCase().equals("associate's degree")
        || edu.toLowerCase().equals("associate degree") || edu.toLowerCase().equals("associate's")
        || edu.toLowerCase().equals("associates degree")) {
      ...
      throw new IllegalArgumentException(
          "Expected education levels: less than hs, hs grad, some college, "
  ...
  public double getPctEduOrMore(String edu) {
    if (edu.toLowerCase().equals("hs grads") || edu.toLowerCase().equals("hs grad")
      ...
      throw new IllegalArgumentException(
          "Expected education levels: high school, bachelor's degree");
    }
  }
  ...
  public double getPctUnmarriedSex(String pref) {
    if (pref.toLowerCase().equals("same") || pref.toLowerCase().equals("same sex")
        || pref.toLowerCase().equals("gay")) {
  ...
  public boolean writeToDB(DBWriter writer) {
    // We never really need to insert Demographics objects b/c we just import the CSV
    return true;
  }
